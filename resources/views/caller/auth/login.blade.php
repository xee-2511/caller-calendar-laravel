...
<html
  ...
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{config('app.url')}}assets/vendor/css/pages/page-auth.css" />
  ...
  <body>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-center">
                ...
                <a href="{{config('app.url')}}login/google/start" class="btn btn-icon rounded-circle btn-text-google-plus">
    ...
    <!-- Page JS -->
    <script src="{{config('app.url')}}assets/js/pages-auth.js"></script>
  </body>
</html>
